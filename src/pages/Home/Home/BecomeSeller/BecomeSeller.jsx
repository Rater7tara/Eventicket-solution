            ...
            <div className="p-6">
              ...
              <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-blue-800 font-semibold mb-1">Important Notice</h4>
                    <p className="text-blue-700 text-sm">
                      Please register first then send the request to become a "seller". Make sure you have a valid account before submitting this form.
                    </p>
                  </div>
                </div>
              </div>
