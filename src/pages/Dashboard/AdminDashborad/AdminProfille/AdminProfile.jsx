  ...
  const fetchProfile = async () => {
    try {
      ...
      if (response.data?.data) {
        ...
        setPasswordData(prev => ({ ...prev, email: response.data.data.email || "" }));
      }
    } catch (err) {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      if (response.data?.success) {
        ...
        // Update user context if you're storing user data there
        if (setUser) {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      if (response.data?.success) {
        ...
        // In a real application, you'd typically redirect to a "check your email" page
        // or show instructions for the next steps
