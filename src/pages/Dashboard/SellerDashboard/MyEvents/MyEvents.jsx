...
const MyEvents = () => {
  ...
  const handleUpdateChange = (e) => {
    ...
    setUpdatedEventData({
      ...updatedEventData,
      [name]:
        name === "ticketsAvailable" || name === "price"
          ? parseInt(value) || 0
          : value,
    });
  };
      ...
      const attemptUpdateWithMultipleEndpoints = async () => {
        ...
        for (const endpoint of possibleEndpoints) {
          for (const method of methods) {
            try {
              console.log(
                `Attempting ${method.toUpperCase()} request to: ${endpoint}`
              );
              ...
              console.log(
                `${method.toUpperCase()} to ${endpoint} failed:`,
                err.message
              );
              lastError = err;
              ...
              {event.image ? (
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src =
                      "https://placehold.co/400x200/orange/white?text=Event+Image";
                  }}
                />
              ) : (
